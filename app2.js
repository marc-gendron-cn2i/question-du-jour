...
// Met à jour la visibilité des “✕” sur les deux premières options
...
// Soumission avec boîte de dialogue en surimpression
  ...
  try {
    ...
    if (check.ok) {
      ...
      if (now < end && existing.options.length === options.length) {
        // BOÎTE DE DIALOGUE IN-PLACE AU LIEU DE confirm()
